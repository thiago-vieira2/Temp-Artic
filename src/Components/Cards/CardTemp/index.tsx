...
export default function Card_temp() {
    ...
    return (
        <div className="bg-[#343A40] w-130 h-100 max-w-sm rounded-2xl flex items-center justify-center">

            <div className="flex flex-col gap-3 items-center text-center">

                <p className='text-[#DEE2E6] text-sm md:text-base'>
                    Leitura atual
                </p>
                ...
                <h1 className={`text-2xl md:text-3xl lg:text-4xl ${TempColor}`}>
                    {temp/100} <span className='text-lg md:text-xl lg:text-2xl'>°C</span>
                </h1>
